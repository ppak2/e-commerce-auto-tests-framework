...
public class CombinationServices extends BaseTest {
    ...
    public void completeCombinationServices(String url, String platform, String zip){
        ...
        thankYouPage.completeCombinationServices(zip);

        new ThankYouPageAssert(thankYouPage).assertCombinationServices(softly);
    }

    @AfterMethod
    public void afterMethod(){ softly.assertAll(); }
}
